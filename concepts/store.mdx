---
title: "The IX Content-Addressed Store"
sidebarTitle: "Store"
description: "Learn how IX uses a content-addressed store at /ix/store to achieve immutable, reproducible package builds with 22-character hash identifiers."
---
...
The hash `0GsKotnAh74LIcvO` (shown here without the full 22 characters for brevity) uniquely identifies this particular build of `bin/bzip2` with exactly these inputs.
