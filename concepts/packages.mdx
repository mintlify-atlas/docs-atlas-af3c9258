...
description: "IX packages are source-built artifacts in a content-addressed store. Learn about namespaces, build isolation, static linking, and the unwrap convention."
---
