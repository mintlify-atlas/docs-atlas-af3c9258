...
sidebarTitle: "Shims"
description: "Use lib/shim/* packages to solve common portability issues declaratively in IX. Avoid sed-patching Makefiles with fake libraries, header redirects, and pkg-config stubs."
---
