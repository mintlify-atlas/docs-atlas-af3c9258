---
title: "IX Package Anatomy: ix.sh Recipe Structure"
sidebarTitle: "Anatomy"
description: "Every IX package is a directory with an ix.sh Jinja2 template. Learn the required structure, key blocks, and how the directory path becomes the package name."
---
