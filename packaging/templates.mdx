...
description: "IX provides Jinja2 base templates for Make, Autotools, CMake, Meson, Cargo, Go, and more. Learn which template to extend and how the inheritance chain works."
---
