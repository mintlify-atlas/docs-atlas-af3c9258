...
description: "Use ix gc to find and remove unused packages from /ix/store by moving them to /ix/trash. Control which prefixes are collected and understand the reachability algorithm."
---
...
The default prefixes when none are specified are: **`lib`**, **`bin`**, **`lnk`**, **`aux`**, and **`rlm`**. These cover the most common package types that accumulate during normal use.
