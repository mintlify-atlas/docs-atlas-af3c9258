...
description: "Build IX packages targeting a different OS or CPU using --target. Covers cross-toolchain setup, the bld/ vs bin/ namespace split, and template variables."
---
