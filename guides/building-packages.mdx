---
title: "Building and Running Packages with ix build and ix run"
...
The `IX_VERBOSE` environment variable causes IX to print package dependencies as they are resolved during the build. IX only checks whether the variable is **set** — any non-empty value activates it:
