---
title: "Managing Realms with ix mut, ix let, and ix list"
sidebarTitle: "Managing Realms"
description: "Install, remove, and update packages in IX realms using mut, let, list, and purge. Learn realm flags, package flags, and the difference between mut and let."
---
