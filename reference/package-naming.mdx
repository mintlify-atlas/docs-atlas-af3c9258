---
title: "IX Package Naming Conventions and Path Canon"
sidebarTitle: "Package Naming"
description: "IX derives package names from directory paths under pkgs/. Learn the canonical naming rules: compound names, hyphens, versions, variants, and special suffixes."
---
...
| `pkgs/lib/open/ssl/ix.sh` | `lib/openssl` |
